...
public class Image_Duplicate_Template extends Common_Methods {
	...
	@BeforeClass
	 ...
	 public void open_Template() throws InterruptedException{
		 Thread.sleep(5000);
		 driver.get("http://beta1.freshproposals.com/home/templates/editTemplate/1330");
	 ...
	 public void height_width() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@id='sectionPage_6731page1']")).click();
		Thread.sleep(2000);
	 ...
	 public void DragDrop() throws InterruptedException{
		 Thread.sleep(3000);
		 Actions action = new Actions(driver);
		 WebElement source = driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-home[1]/div[1]/div[5]/div[1]/app-edit-template[1]/div[1]/div[2]/div[2]/div[1]/div[1]/app-edit-section[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/app-sections-page[1]/a[1]/div[1]/div[1]/div[1]/app-fpimage[2]/div[1]/div[1]/div[1]/div[9]/img[1]"));
		 WebElement des = driver.findElement(By.xpath("//div[@id='sectionPage_6731page1']"));
	 ...
	 @Test(priority = 6)
	  public void assert_width_2() throws InterruptedException {
		 driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-home[1]/div[1]/div[5]/div[1]/app-edit-template[1]/div[1]/div[2]/div[2]/div[1]/div[1]/app-edit-section[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/app-sections-page[1]/a[1]/div[1]/div[1]/div[1]/app-fpimage[2]/div[1]/div[1]/div[1]/div[9]/img[1]")).click();
		  String actual_reflect_width = driver.findElement(By.xpath("/html[1]/body[1]/app-root[1]/app-home[1]/div[1]/div[5]/div[1]/app-edit-template[1]/div[1]/div[2]/div[2]/div[1]/div[1]/app-edit-section[2]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/app-sections-page[1]/a[1]/div[1]/div[1]/div[1]/app-fpimage[2]/div[1]/div[1]/div[1]/div[9]/img[1]")).getCssValue("width");
		  String expected_reflect_width = width+"px";
	 ...
	 @Test(priority = 9)
	  public void reset_sign_1() throws InterruptedException {
		...
		driver.findElement(By.xpath("//div[@class='resizers']//img")).click();
		driver.findElement(By.name("width11")).clear();
		driver.findElement(By.name("width11")).sendKeys("640");
		driver.findElement(By.xpath("//div[@id='sectionPage_6731page1']")).click();
