	 ...
	 @BeforeClass
	  public void openBrowser() {
	 	...
	 	public void Repeater() throws InterruptedException {
	 		...
	 		RepeterMenu.click();
//	 		WebElement TextFontSize = driver.findElement(By.xpath("//div[@id='page2-FPText1230201911381431mainDivTransformSafeStyle']//p[1]"));
//	 		
...
//					Thread.sleep(5000);
//	 	}
//	 	@Test(priority =9,dependsOnMethods = {"login"},enabled=false)
