...
public class Image_DragDrop_Position_Proposal extends Common_Methods {
  ...
  Thread.sleep(3000);
  driver.get("http://beta1.freshproposals.com/home/proposals/editProposal;proposalId=1776;editor=true");
	}
  ...
  public void Get_Position() throws InterruptedException {
	 ...
	 System.out.println("Before Drag and Drop Y "+editor_y);
	  ...
	  Thread.sleep(2000);
	  driver.get("http://beta1.freshproposals.com/home/viewproposal/1776/preview/proposals");
  ...
  @Test(priority = 3)
   public void DragDrop() throws InterruptedException {
	  ...
	  WebElement des = driver.findElement(By.xpath("//div[@id='sectionPage_6626page1']"));
