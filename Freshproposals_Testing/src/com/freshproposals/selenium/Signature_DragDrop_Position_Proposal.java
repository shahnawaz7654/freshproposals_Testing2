...
public class Signature_DragDrop_Position_Proposal extends Common_Methods {
 ...
 @Test(dataProvider = "User1" , priority = 0)
  ...
  Thread.sleep(3000);
  driver.get("http://beta1.freshproposals.com/home/proposals/editProposal;proposalId=1773;editor=true");
	}
  ...
  public void Get_Position() throws InterruptedException {
	 ...
	 System.out.println("Before Drag and Drop Y "+editor_y);
	  ...
	  Thread.sleep(2000);
	  driver.get("http://beta1.freshproposals.com/home/viewproposal/1773/preview/proposals");
