...
public class Signature_Duplicate_Template extends Common_Methods {
	...
	@Test(dataProvider = "User1", priority = 0)
	 ...
	 public void open_Template() throws InterruptedException{
		 Thread.sleep(5000);
		 driver.get("http://beta1.freshproposals.com/home/templates/editTemplate/1324");
	 ...
	 public void height_width() throws InterruptedException {
		Thread.sleep(3000);
		driver.findElement(By.id("page1-fpSign1226201911324022")).click();
	 ...
	 @Test(priority = 3)
	  public void assert_width_1() throws InterruptedException {
		 driver.findElement(By.id("page1-fpSign1226201911324022")).click();
		  String actual_reflect_width = driver.findElement(By.id("page1-fpSign1226201911324022")).getCssValue("width");
	 ...
	 @Test(priority = 4)
	  public void assert_height_1() throws InterruptedException {
		 driver.findElement(By.id("page1-fpSign1226201911324022")).click();
		  String actual_reflect_height = driver.findElement(By.id("page1-fpSign1226201911324022")).getCssValue("height");
	 ...
	 public void duplicate() throws InterruptedException{
		 ...
		 action.contextClick(driver.findElement(By.id("page1-fpSign1226201911324022"))).perform();
		 Thread.sleep(1000);
